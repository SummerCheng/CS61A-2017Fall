...
(define (make-exp base exponent)
  (cond ((=number? base 1) 1)
        ...
        ((and (number? base) (number? exponent)) (make-product base (make-exp base (- exponent 1))))
...
(define (exp? exp)
  (and (list? exp) (number? (exponent exp)) (> (exponent exp) 1))
)
...
(define (derive-exp exp var)
  (if (exp? exp) (make-product (exponent exp) (make-product (make-exp (base exp) (- (exponent exp) 1)) (derive (base exp) var))
))
)