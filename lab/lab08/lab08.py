...
def add_trees(t1, t2):
    ...
    len1, len2 = len(t1.branches), len(t2.branches)
    branches1, branches2 = t1.branches, t2.branches

    if len1 < len2:
        branches1 += [None for _ in range(0, len2-len1)]
    elif len1 > len2:
        branches2 += [None for _ in range(0, len1-len2)]
    return Tree(new_label, [add_trees(b1,b2) for b1,b2 in zip(branches1, branches2) ])
