...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        """
        if insect.is_ant:
            if isinstance(insect, QueenAnt) and insect.first:
                return 
            else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        place=self.place
        distance = 0
        while place.entrance and place.entrance is not hive and distance<self.max_range:
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        ...
        self.digest_count = self.time_to_digest
        self.digesting = 1
